describe('New Snippet Form', () => {
  ...
  it('focuses the editor on load', () => {
    cy.focused()
      .should('have.class', 'ace_text-input');
  });

  it('should have list of 97 syntaxes', () => {
    const syntaxesLength = 97;

    cy.get('.new-snippet-lang-item')
      .should('have.length', syntaxesLength);
  });
  ...
  it('should select JavaScript syntax', () => {
    cy.get('.new-snippet-lang-header > .input')
      .clear()
      .type('java');
